...
%One of the drawbacks of the remote testing is the need for data transfer. Because of this, we implemented two use cases. First use-case, intended for common user, is that he will go to a website and will upload his or her data via web browser. This is slower that direct upload to the server and viable only if the user doesn't have too much data to test.
