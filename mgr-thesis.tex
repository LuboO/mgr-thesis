...
%\begin{nomar}
%\centering
%\includegraphics[width=\textwidth]{figures/dieharder-orig.pdf} 
%\includegraphics[width=\textwidth]{figures/dieharder-corr.pdf} 
%\caption{Placeholder}
...
In this section we will present the configurations of the respective batteries that were used in both above-mentioned experiments. The settings were kept as close as possible to the default settings of the respective batteries; because of this, the results of the batteries executed through RTT are comparable to the results of the batteries when directly executed. 
...
$$
Rep(n) = \min\left(100 ; \left\lfloor \frac{ 8000 \times 1024^{2} }{ (n + 1) \times 4 \times 10^{6} } \right\rfloor \right)
$$

\subsection*{TestU01}
The batteries Small Crush and Crush are executed in their default settings. The default settings of the tests can be found in Appendix~\ref{app:testu01_tests}.
