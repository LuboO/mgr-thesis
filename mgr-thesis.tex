...
%\begin{itemize}
%\item Intro - seeing whether premises holds - Type I error and uniformity of statistics
%\item Doesn't have to introduce Dieharder OR the stats
%\item Just present the experiment and show and discuss results. 4 pages no bigge.
%\end{itemize}
